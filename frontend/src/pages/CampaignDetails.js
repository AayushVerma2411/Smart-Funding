...
const CampaignDetails = () => {
  ...
  const remainingDays = daysLeft(hex_to_int_date(state.deadline));
  const contract=0,address=0;
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox title={`Raised of ${hex_to_int(state.target)}`} value={hex_to_int(state.amountCollected)} />
